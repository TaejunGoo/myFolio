...
export const projectDetailData: ProjectDetailData[] = [
    ...
    customSections: [
      {
        ...
        content: [
          ...
          "React Router of 스크롤 동작 관리 기능이 프로젝트 버전과 호환되지 않음",
  ...
  },
  {
    ...
    overview:
      "KBS 티벗은 KBS 방송 참여 플랫폼으로, 실시간 방송과 연동되어 방송 중 댓글 전송, 투표 등 시청자 참여 기능을 제공하는 서비스입니다. HTML, SASS 기반으로 모바일에 최적화된 서비스를 구현했으며, 고연령층 사용자가 많은 서비스 특성상을 고려해 SASS와 CSS variable을 활용한 폰트 크기 테마 기능을 구현하여 접근성을 향상시켰습니다.",
    role: [
